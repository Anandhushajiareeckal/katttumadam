            ...
            <div class="card mb-4">
                <div class="card-body card-main-three">
                    ...
                    <form class="form-floating" action="{{route('logo_update')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            <span class="form-floating">
                                <input type="text" class="form-control" id="TextInput" placeholder="Eg: fa fa-facebook" name="notification"  value="{{$logo->notification}}" >
                                <label class="" for="TextInput">Notification</label>
                            </span>
                        </div>
