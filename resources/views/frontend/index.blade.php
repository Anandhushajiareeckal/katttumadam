...
@foreach ($home_banner as $item)
	...
	<div class="hero-area home-six align-items-center d-flex" style="background: url({{$item->image}});background-repeat: no-repeat;
...
<marquee style="font-family:meera; fontsize:16pt; color:#FFCC33 ;width:1254; background:#000000; height:25px;">Cyenosure cyenosure Cyenosure cyenosure Cyenosure cyenosureCyenosure cyenosureCyenosure cyenosureCyenosure cyenosureCyenosure cyenosureCyenosure cyenosureCyenosure cyenosureCyenosure cyenosure</marquee>
		...
		<div class="row">
			<div class="col-md-12 text-center" data-cue="zoomIn">
				<div class="section-title center home-two">
					<h1>Gallery</h1>
					<p class="section-desc-2 home-two">Embark on a journey to experience the harmonious blend of heritage, craftsmanship, and religious traditions at Kattumadam Mana through our evocative visual storytelling.</p>
                    <div class="luxury-button">
		...
		<div class="row">
			<div class="col-md-12 text-center">
				<div class="section-title center home-two" data-cue="zoomIn">
					<h1>Our Events</h1>
					<p class="section-desc-2 home-two">See our latest news and events here</p>
				</div>
			</div>
		</div>
	</div>
